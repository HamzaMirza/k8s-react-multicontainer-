...
kubectl set image deployments/client-deployment client=hamza156/docker-react-app-client-image:$SHA
kubectl set image deployments/server-deployment server=hamza156/docker-react-app-server-image:$SHA
kubectl set image deployments/worker-deployment worker=hamza156/docker-react-app-worker-image:$SHA